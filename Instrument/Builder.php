...
use Voyager\Database\Instrument\Concerns\QueriesRelationships;
 ...
 *
 * @mixin \Voyager\Database\Query\Builder
 */
class Builder implements BuilderContract
{
    /** @use \Voyager\Database\Concerns\BuildsQueries<TModel> */
     ...
     *
     * @var \Voyager\Database\Query\Builder
     */
    protected $query;
    ...
    /**
     * Create a new Instrument query builder instance.
     *
     ...
     * @param  \Voyager\Database\Instrument\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Scope|string  $scope
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\Voyager\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\Voyager\Contracts\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  string|\Voyager\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \Voyager\Database\Instrument\Collection<int, TModel>
     */
     ...
     * @return ($id is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>) ? \Voyager\Database\Instrument\Collection<int, TModel> : TModel|null)
     */
     ...
     * @return TModel
     *
     * @throws \Voyager\Database\Instrument\ModelNotFoundException<TModel>
     ...
     *
     * @param  \Voyager\Contracts\NutsAndBolts\Arrayable|array  $ids
     * @param  array|string  $columns
     * @return \Voyager\Database\Instrument\Collection<int, TModel>
     */
     ...
     * @param  mixed  $id
     * @param  array|string  $columns
     * @return ($id is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>) ? \Voyager\Database\Instrument\Collection<int, TModel> : TModel)
     *
     * @throws \Voyager\Database\Instrument\ModelNotFoundException<TModel>
     */
     ...
     * @return (
     *     $id is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Voyager\Database\Instrument\Collection<int, TModel>
     *     : TModel|TValue
     * )
     */
     ...
     *
     * @param  string  $name
     * @return \Voyager\Database\Instrument\Relations\Relation<\Voyager\Database\Instrument\Model, TModel, *>
     */
     ...
     *
     * @return \Voyager\NutsAndBolts\LazyCollection<int, TModel>
     */
    ...
    public function pluck($column, $key = null)
    {
        ...
        // columns are returned as you would expect from these Instrument models.
     ...
     * @return \Voyager\Pagination\LengthAwarePaginator<int, TModel>
     *
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Voyager\Pagination\Paginator<int, TModel>
     */
     ...
     * @return \Voyager\Pagination\CursorPaginator<int, TModel>
     */
    ...
    /**
     * Apply the scopes to the Instrument builder instance and return it.
     *
     * @return static
     */
     ...
     *
     * @param  array<array-key, array|(\Closure(\Voyager\Database\Instrument\Relations\Relation<*,*,*>): mixed)|string>|string  $relations
     * @param  (\Closure(\Voyager\Database\Instrument\Relations\Relation<*,*,*>): mixed)|string|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|array|string  $attributes
     * @param  mixed  $value
    ...
    /**
     * Get the Instrument builder instances that are used in the union of the query.
     *
     * @return \Voyager\NutsAndBolts\Collection
     */
     ...
     *
     * @template TModelNew of \Voyager\Database\Instrument\Model
     *
     ...
     *
     * @param  array|\Voyager\Contracts\Database\Query\Expression  $columns
     * @return array
     */
    ...
    public function __get($key)
    {
        ...
        throw new Exception("Property [{$key}] does not exist on the Instrument builder instance.");
    }
    ...
    /**
     * Clone the Instrument query builder.
     *
     * @return static
     */
