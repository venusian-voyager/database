...
use Voyager\Database\Instrument\Attributes\Boot;
use Voyager\Database\Instrument\Attributes\Initialize;
use Voyager\Database\Instrument\Attributes\Scope as LocalScope;
use Voyager\Database\Instrument\Attributes\UseInstrumentBuilder;
...
use Voyager\NutsAndBolts\DataObjects\Stringable as SupportStringable;
...
abstract class Model implements Arrayable, ArrayAccess, CanBeEscapedWhenCastToString, HasBroadcastChannel, Jsonable, JsonSerializable, QueueableEntity, Stringable
{
    use Concerns\HasAttributes,
        ...
        // Concerns\TransformsToResource is cut: it turns a model into an
        // Http\Resources\Json\JsonResource, and Http is ported as the client only.
        ForwardsCalls;
    /** @use HasCollection<\Voyager\Database\Instrument\Collection<array-key, static & self>> */
    use HasCollection;
    ...
    /**
     * The Instrument query builder class to use for the model.
     *
     * @var class-string<\Voyager\Database\Instrument\Builder<*>>
     */
    protected static string $builder = Builder::class;

    /**
     * The Instrument collection class to use for the model.
     *
     * @var class-string<\Voyager\Database\Instrument\Collection<*, *>>
     */
    ...
    /**
     * Create a new Instrument model instance.
     *
     ...
     * @return $this
     *
     * @throws \Voyager\Database\Instrument\MassAssignmentException
     */
    ...
    public function newInstance($attributes = [], $exists = false)
    {
        ...
        // hydration of new objects via the Instrument query builder instances.
        $model = new static;
     ...
     * @return \Voyager\Database\Instrument\Collection<int, static>
     */
     ...
     *
     * @param  \Voyager\NutsAndBolts\Collection|array|int|string  $ids
     * @return int
     */
    public static function destroy($ids)
    {
        if ($ids instanceof InstrumentCollection) {
            $ids = $ids->modelKeys();
        }
    ...
    {
        return $this->newInstrumentBuilder(
     ...
     *
     * @param  \Voyager\Database\Instrument\Builder<static>  $builder
     * @return \Voyager\Database\Instrument\Builder<static>
     */
    ...
    /**
     * Create a new Instrument query builder for the model.
     *
     * @param  \Voyager\Database\Query\Builder  $query
     * @return \Voyager\Database\Instrument\Builder<*>
     */
    public function newInstrumentBuilder($query)
    {
    ...
    /**
     * Resolve the custom Instrument builder class from the model attributes.
     *
     * @return class-string<\Voyager\Database\Instrument\Builder>|false
     */
    protected function resolveCustomBuilderClass()
    {
        $attributes = (new ReflectionClass($this))
            ->getAttributes(UseInstrumentBuilder::class);
     ...
     * @return \Voyager\Database\Instrument\Relations\Pivot
     */
     ...
     * @return string
     *
     * @throws \Voyager\Database\Instrument\JsonEncodingException
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Model|null  $model
     * @return bool
     */
     ...
     *
     * @return \Voyager\Database\ConnectionResolverInterface|null
     */
    ...
    // Laravel resolves a URL segment into a model here — route-model binding,
    // across getRouteKey(), resolveRouteBinding() and their child/soft-delete
    // variants. Routing is receiving-HTTP, so the whole block is cut along with
    // the UrlRoutable contract this class implemented for it.
