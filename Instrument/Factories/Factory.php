...
abstract class Factory
{
     ...
     * @param  \Voyager\NutsAndBolts\Collection|null  $states
     * @param  \Voyager\NutsAndBolts\Collection|null  $has
     * @param  \Voyager\NutsAndBolts\Collection|null  $for
     * @param  \Voyager\NutsAndBolts\Collection|null  $afterMaking
     * @param  \Voyager\NutsAndBolts\Collection|null  $afterCreating
     * @param  \UnitEnum|string|null  $connection
     * @param  \Voyager\NutsAndBolts\Collection|null  $recycle
     ...
     *
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \Voyager\Database\Instrument\Model|null  $parent
     ...
     * @param  (callable(array<string, mixed>): array<string, mixed>)|array<string, mixed>  $attributes
     * @param  \Voyager\Database\Instrument\Model|null  $parent
     * @return \Voyager\Database\Instrument\Collection<int, TModel>|TModel
     */
     ...
     * @param  \Voyager\Database\Instrument\Model|null  $parent
     * @return \Closure(): (\Voyager\Database\Instrument\Collection<int, TModel>|TModel)
     */
     ...
     *
     * @param  \Voyager\NutsAndBolts\Collection<int, \Voyager\Database\Instrument\Model>  $results
     * @return void
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Factories\Factory|\Voyager\NutsAndBolts\Collection|\Voyager\Database\Instrument\Model|array  $factory
     ...
     *
     * @param  \Voyager\Database\Instrument\Model|\Voyager\NutsAndBolts\Collection|array  $model
     * @return static
     */
     ...
     *
     * @template TClass of \Voyager\Database\Instrument\Model
     *
     ...
     *
     * @param  \Closure(TModel, \Voyager\Database\Instrument\Model|null): mixed  $callback
     * @return static
     */
     ...
     *
     * @param  \Voyager\NutsAndBolts\Collection  $instances
     * @return void
     */
     ...
     * @return \Voyager\Database\Instrument\Factories\Factory<TClass>
     */
     ...
     *
     * @param  callable(class-string<\Voyager\Database\Instrument\Model>): class-string<\Voyager\Database\Instrument\Factories\Factory>  $callback
     * @return void
     */
     ...
     *
     * @param  class-string<TClass>  $modelName
     * @return class-string<\Voyager\Database\Instrument\Factories\Factory<TClass>>
     */
