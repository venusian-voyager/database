 ...
 *
 * @extends \Voyager\NutsAndBolts\Collection<TKey, TModel>
 */
class Collection extends BaseCollection implements QueueableCollection
{
     ...
     * @return ($key is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>) ? static : TModel|TFindDefault)
     */
     ...
     *
     * @param  array<array-key, array|(callable(\Voyager\Database\Instrument\Relations\Relation<*, *, *>): mixed)|string>|string  $relations
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Collection<int, TModel>  $models
     * @param  array  $path
     * @return void
     */
     ...
     * @param  array<array-key, array|(callable(\Voyager\Database\Instrument\Relations\Relation<*, *, *>): mixed)|string>  $relations
     * @return $this
     */
     ...
     * @return \Voyager\NutsAndBolts\Collection<TKey, TMapValue>|static<TKey, TMapValue>
     */
     ...
     * @return \Voyager\NutsAndBolts\Collection<TMapWithKeysKey, TMapWithKeysValue>|static<TMapWithKeysKey, TMapWithKeysValue>
     */
     ...
     * {@inheritDoc}
     *
     * @return \Voyager\NutsAndBolts\Collection<array-key, int>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Voyager\NutsAndBolts\Collection<int, mixed>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Voyager\NutsAndBolts\Collection<TModel, TKey>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Voyager\NutsAndBolts\Collection<int, TKey>
     */
    #[\Override]
     ...
     * @template TPadValue
     *
     * @return \Voyager\NutsAndBolts\Collection<int, TModel|TPadValue>
     */
    #[\Override]
     ...
     * {@inheritDoc}
     *
     * @return \Voyager\NutsAndBolts\Collection<int<0, 1>, static<TKey, TModel>>
     */
    #[\Override]
     ...
     * @template TZipValue
     *
     * @return \Voyager\NutsAndBolts\Collection<int, \Voyager\NutsAndBolts\Collection<int, TModel|TZipValue>>
     */
    #[\Override]
    ...
    /**
     * Get the Instrument query builder from the collection.
     *
