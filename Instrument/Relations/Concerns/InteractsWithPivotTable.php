...
trait InteractsWithPivotTable
{
     ...
     *
     * @param  \Voyager\NutsAndBolts\Collection|\Voyager\Database\Instrument\Model|array|int|string  $ids
     ...
     *
     * @param  \Voyager\NutsAndBolts\Collection|\Voyager\Database\Instrument\Model|array  $ids
     * @param  bool  $detaching
     * @return array{attached: array, detached: array, updated: array}
     *
     * @throws \Throwable
    ...
    protected function parseIds($value)
    {
        ...
        if ($value instanceof InstrumentCollection) {
