...
trait SupportsInverseRelations
{
    ...
    /**
     * Instruct Instrument to link the related models back to the parent after the relationship query has run.
     *
     * Alias of "chaperone".
     *
     ...
     *
     * @param  \Voyager\Database\Instrument\Collection  $models
