 ...
 * @template TResult
 *
 * @mixin \Voyager\Database\Instrument\Builder<TRelatedModel>
 */
abstract class Relation implements BuilderContract
{
    ...
    /**
     * The Instrument query builder instance.
     *
     * @var \Voyager\Database\Instrument\Builder<TRelatedModel>
     */
    protected $query;
     ...
     *
     * @var array<string, class-string<\Voyager\Database\Instrument\Model>>
     */
     ...
     * @return array<int, TDeclaringModel>
     */
    abstract public function match(array $models, InstrumentCollection $results, $relation);
    ...
    /**
     * Get the base query builder driving the Instrument builder.
     *
     ...
     *
     * @param  array<array-key, class-string<\Voyager\Database\Instrument\Model>>  $map
     * @param  bool  $merge
     * @return array
     */
     ...
     *
     * @param  array<array-key, class-string<\Voyager\Database\Instrument\Model>>|null  $map
     * @param  bool  $merge
     * @return array<string, class-string<\Voyager\Database\Instrument\Model>>
     */
     ...
     *
     * @param  array<array-key, class-string<\Voyager\Database\Instrument\Model>>|null  $models
     * @return array<string, class-string<\Voyager\Database\Instrument\Model>>|null
     */
     ...
     *
     * @param  string  $alias
     * @return class-string<\Voyager\Database\Instrument\Model>|null
     */
     ...
     *
     * @param  class-string<\Voyager\Database\Instrument\Model>  $className
     * @return int|string
     */
