 ...
 *
 * @extends \Voyager\Database\Instrument\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
 */
class MorphTo extends BelongsTo
{
     ...
     *
     * @var \Voyager\Database\Instrument\Collection<int, TDeclaringModel>
     */
    protected $models;
    ...
    {
        $this->buildDictionary($this->models = new InstrumentCollection($models));
    }

    /**
     * Build a dictionary with the models.
     *
     * @param  \Voyager\Database\Instrument\Collection<int, TRelatedModel>  $models
     * @return void
     */
    protected function buildDictionary(InstrumentCollection $models)
    {
     ...
     *
     * Called via eager load method of Instrument query builder.
     *
     * @return \Voyager\Database\Instrument\Collection<int, TDeclaringModel>
     */
     ...
     * @return void
     */
    protected function matchToMorphParents($type, InstrumentCollection $results)
    {
