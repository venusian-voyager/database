 ...
 * @template TResult
 *
 * @extends \Voyager\Database\Instrument\Relations\Relation<TRelatedModel, TIntermediateModel, TResult>
 */
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>) ? \Voyager\Database\Instrument\Collection<int, TRelatedModel> : TRelatedModel|null)
     */
     ...
     * @param  array  $columns
     * @return \Voyager\Database\Instrument\Collection<int, TRelatedModel>
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return ($id is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>) ? \Voyager\Database\Instrument\Collection<int, TRelatedModel> : TRelatedModel)
     *
     * @throws \Voyager\Database\Instrument\ModelNotFoundException<TRelatedModel>
     */
     ...
     *     ? \Voyager\Database\Instrument\Collection<int, TRelatedModel>|TValue
     ...
     *
     * @return \Voyager\NutsAndBolts\LazyCollection<int, TRelatedModel>
     */
