 ...
 * @template TResult
 *
 * @extends \Voyager\Database\Instrument\Relations\Relation<TRelatedModel, TDeclaringModel, TResult>
 */
abstract class HasOneOrMany extends Relation
{
     ...
     */
    public function matchOne(array $models, InstrumentCollection $results, $relation)
    {
     ...
     * @return array<int, TDeclaringModel>
     */
    public function matchMany(array $models, InstrumentCollection $results, $relation)
    {
     ...
     * @return array<int, TDeclaringModel>
     */
    protected function matchOneOrMany(array $models, InstrumentCollection $results, $relation, $type)
    {
