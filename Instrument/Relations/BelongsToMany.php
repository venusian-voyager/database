...
use Voyager\Database\Instrument\Relations\Concerns\InteractsWithPivotTable;
 ...
 * @template TPivotModel of \Voyager\Database\Instrument\Relations\Pivot = \Voyager\Database\Instrument\Relations\Pivot
 * @template TAccessor of string = 'pivot'
 *
 * @extends \Voyager\Database\Instrument\Relations\Relation<TRelatedModel, TDeclaringModel, \Voyager\Database\Instrument\Collection<int, TRelatedModel&object{pivot: TPivotModel}>>
 *
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\Voyager\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Collection<int, TRelatedModel>  $results
     * @return array<array<array-key, TRelatedModel>>
     */
    protected function buildDictionary(InstrumentCollection $results)
    {
     ...
     *
     * @template TNewPivotModel of \Voyager\Database\Instrument\Relations\Pivot
     *
     ...
     *
     * @param  string|\Voyager\Contracts\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     *     ? \Voyager\Database\Instrument\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     ...
     * @return TRelatedModel&object{pivot: TPivotModel}
     *
     * @throws \Voyager\Database\Instrument\ModelNotFoundException<TRelatedModel>
     ...
     * @param  array  $columns
     * @return \Voyager\Database\Instrument\Collection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return (
     *     $id is (\Voyager\Contracts\NutsAndBolts\Arrayable<array-key, mixed>|array<mixed>)
     *     ? \Voyager\Database\Instrument\Collection<int, TRelatedModel&object{pivot: TPivotModel}>|TValue
     ...
     * @param  int|null  $page
     * @return \Voyager\Pagination\LengthAwarePaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Voyager\Contracts\Pagination\Paginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     * @return \Voyager\Contracts\Pagination\CursorPaginator<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Voyager\NutsAndBolts\LazyCollection<int, TRelatedModel&object{pivot: TPivotModel}>
     */
     ...
     *
     * @return \Voyager\Database\Instrument\Builder<TRelatedModel>
     */
     ...
     *
     * @return \Voyager\NutsAndBolts\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \Voyager\NutsAndBolts\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \Voyager\Database\Instrument\Builder<TRelatedModel>  $query
     * @param  \Voyager\Database\Instrument\Builder<TDeclaringModel>  $parentQuery
     * @param  mixed  $columns
     * @return \Voyager\Database\Instrument\Builder<TRelatedModel>
     */
     ...
     *
     * @param  string|\Voyager\Contracts\Database\Query\Expression  $column
     * @return string|\Voyager\Contracts\Database\Query\Expression
     */
