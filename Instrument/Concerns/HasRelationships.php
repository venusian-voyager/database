...
use Voyager\Database\Instrument\PendingHasThroughRelationship;
...
trait HasRelationships
{
     ...
     * @return \Voyager\Database\Instrument\Relations\HasOne<TRelatedModel, $this>
     */
     ...
     * @return \Voyager\Database\Instrument\Relations\HasOneThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string|null  $localKey
     * @return \Voyager\Database\Instrument\Relations\MorphOne<TRelatedModel, $this>
     */
     ...
     * @return \Voyager\Database\Instrument\Relations\BelongsTo<TRelatedModel, $this>
     */
    public function belongsTo($related, $foreignKey = null, $ownerKey = null, $relation = null)
    {
        ...
        // Once we have the foreign key names we'll just create a new Instrument query
     ...
     * @return \Voyager\Database\Instrument\Relations\BelongsTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string  $type
     * @param  string  $relation
     * @return \Voyager\Database\Instrument\Relations\MorphTo<TRelatedModel, TDeclaringModel>
     */
     ...
     * @template TIntermediateModel of \Voyager\Database\Instrument\Model
     *
     * @param  string|\Voyager\Database\Instrument\Relations\HasMany<TIntermediateModel, covariant $this>|\Voyager\Database\Instrument\Relations\HasOne<TIntermediateModel, covariant $this>  $relationship
     * @return (
     *     $relationship is string
     *     ? \Voyager\Database\Instrument\PendingHasThroughRelationship<\Voyager\Database\Instrument\Model, $this>
     *     : (
     *          $relationship is \Voyager\Database\Instrument\Relations\HasMany<TIntermediateModel, $this>
     *          ? \Voyager\Database\Instrument\PendingHasThroughRelationship<TIntermediateModel, $this, \Voyager\Database\Instrument\Relations\HasMany<TIntermediateModel, $this>>
     *          : \Voyager\Database\Instrument\PendingHasThroughRelationship<TIntermediateModel, $this, \Voyager\Database\Instrument\Relations\HasOne<TIntermediateModel, $this>>
     *     )
     * )
     */
     ...
     * @param  string|null  $foreignKey
     * @param  string|null  $localKey
     * @return \Voyager\Database\Instrument\Relations\HasMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $localKey
     * @return \Voyager\Database\Instrument\Relations\HasMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $localKey
     * @param  string|null  $secondLocalKey
     * @return \Voyager\Database\Instrument\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, $this>
     */
     ...
     * @param  string  $localKey
     * @param  string  $secondLocalKey
     * @return \Voyager\Database\Instrument\Relations\HasManyThrough<TRelatedModel, TIntermediateModel, TDeclaringModel>
     */
     ...
     * @param  string|null  $id
     * @param  string|null  $localKey
     * @return \Voyager\Database\Instrument\Relations\MorphMany<TRelatedModel, $this>
     */
     ...
     * @param  string  $id
     * @param  string  $localKey
     * @return \Voyager\Database\Instrument\Relations\MorphMany<TRelatedModel, TDeclaringModel>
     */
     ...
     *
     * @param  class-string<TRelatedModel>  $related
     * @param  string|class-string<\Voyager\Database\Instrument\Model>|null  $table
     * @param  string|null  $foreignPivotKey
     * @param  string|null  $relatedPivotKey
     * @param  string|null  $parentKey
     * @param  string|null  $relatedKey
     * @param  string|null  $relation
     * @return \Voyager\Database\Instrument\Relations\BelongsToMany<TRelatedModel, $this, \Voyager\Database\Instrument\Relations\Pivot>
     */
     ...
     * @param  \Voyager\Database\Instrument\Builder<TRelatedModel>  $query
     * @param  TDeclaringModel  $parent
     * @param  string|class-string<\Voyager\Database\Instrument\Model>  $table
     * @param  string  $foreignPivotKey
     * @param  string  $relatedPivotKey
     * @param  string  $parentKey
     * @param  string  $relatedKey
     * @param  string|null  $relationName
     * @return \Voyager\Database\Instrument\Relations\BelongsToMany<TRelatedModel, TDeclaringModel, \Voyager\Database\Instrument\Relations\Pivot>
     */
     ...
     * @param  string|null  $relation
     * @param  bool  $inverse
     * @return \Voyager\Database\Instrument\Relations\MorphToMany<TRelatedModel, $this>
     */
     ...
     * @param  string|null  $relationName
     * @param  bool  $inverse
     * @return \Voyager\Database\Instrument\Relations\MorphToMany<TRelatedModel, TDeclaringModel>
     */
     ...
     * @param  \Voyager\Database\Instrument\Model|null  $instance
     * @return string
     */
    ...
    public function touchOwners()
    {
        $this->withoutRecursion(function () {
            foreach ($this->getTouchedRelations() as $relation) {
                ...
                } elseif ($this->$relation instanceof InstrumentCollection) {
