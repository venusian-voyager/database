...
/** @mixin \Voyager\Database\Instrument\Builder */
trait QueriesRelationships
{
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  string  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Voyager\Database\Instrument\Builder<TRelatedModel>): mixed)|null  $callback
     * @return $this
     *
    ...
    public function has($relation, $operator = '>=', $count = 1, $boolean = 'and', ?Closure $callback = null)
    {
        ...
        // proper logical grouping of the where clauses if needed by this Instrument query
     ...
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Voyager\Database\Instrument\Builder<*>): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\Relation<*, *, *>|string  $relation
     * @param  string  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @param  (\Closure(\Voyager\Database\Instrument\Builder<*>|\Voyager\Database\Instrument\Relations\Relation<*, *, *>): mixed)|null  $callback
     * @param  string  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @return $this
     */
     ...
     * @template TRelatedModel of \Voyager\Database\Instrument\Model
     *
     * @param  \Voyager\Database\Instrument\Relations\MorphTo<TRelatedModel, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     * @param  (\Closure(\Voyager\Database\Instrument\Builder<TRelatedModel>, string): mixed)|null  $callback
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\MorphTo<*, TDeclaringModel>  $relation
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\MorphTo<*, *>|string  $relation
     * @param  string|array<int, string>  $types
     * @param  string  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @return $this
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\Relation<TRelatedModel, *, *>|string  $relation
     * @param  (\Closure(\Voyager\Database\Instrument\Builder<TRelatedModel>): mixed)|string|array|\Voyager\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\MorphTo<*, *>|string  $relation
     * @param  \Voyager\Database\Instrument\Model|iterable<int, \Voyager\Database\Instrument\Model>|string|null  $model
     * @return $this
     *
     ...
     *
     * @param  \Voyager\Database\Instrument\Relations\MorphTo<*, *>|string  $relation
     * @param  \Voyager\Database\Instrument\Model|iterable<int, \Voyager\Database\Instrument\Model>|string  $model
     * @return $this
     *
     * @throws \InvalidArgumentException
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Model|\Voyager\Database\Instrument\Collection<int, \Voyager\Database\Instrument\Model>  $related
     * @param  string|null  $relationshipName
     * @param  string  $boolean
     * @return $this
     *
     * @throws \Voyager\Database\Instrument\RelationNotFoundException
     */
    public function whereBelongsTo($related, $relationshipName = null, $boolean = 'and')
    {
        if (! $related instanceof InstrumentCollection) {
     ...
     *
     * @param  \Voyager\Database\Instrument\Model  $related
     * @param  string|null  $relationshipName
     * @return $this
     *
     * @throws \RuntimeException
    ...
    {
        $relatedCollection = $related instanceof InstrumentCollection ? $related : $related->newCollection([$related]);
     ...
     *
     * @param  string  $column
     * @param  \Voyager\Database\Instrument\Relations\Relation<*, *, *>  $relation
     * @return string
     */
     ...
     *
     * @param  \Voyager\Database\Instrument\Builder<*>  $hasQuery
     * @param  \Voyager\Database\Instrument\Relations\Relation<*, *, *>  $relation
     * @param  string  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|int  $count
     * @param  string  $boolean
     ...
     *
     * @param  \Voyager\Database\Instrument\Builder<*>  $from
     * @return $this
     */
     ...
     *
     * @param  string  $relation
     * @return \Voyager\Database\Instrument\Relations\Relation<*, *, *>
     */
