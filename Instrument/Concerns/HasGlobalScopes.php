...
trait HasGlobalScopes
{
     ...
     *
     * @param  \Voyager\Database\Instrument\Scope|(\Closure(\Voyager\Database\Instrument\Builder<static>): mixed)|string  $scope
     * @param  \Voyager\Database\Instrument\Scope|(\Closure(\Voyager\Database\Instrument\Builder<static>): mixed)|null  $implementation
     * @return mixed
     *
     ...
     *
     * @param  \Voyager\Database\Instrument\Scope|string  $scope
     * @return \Voyager\Database\Instrument\Scope|(\Closure(\Voyager\Database\Instrument\Builder<static>): mixed)|null
     */
