...
use Voyager\Database\Instrument\Casts\Json;
use Voyager\Database\Instrument\InvalidCastException;
...
use Voyager\Database\LazyLoadingViolationException;
...
trait HasAttributes
{
    ...
    /**
     * The built-in, primitive cast types supported by Instrument.
     *
     * @var string[]
     */
     ...
     *
     * @var \Voyager\Contracts\Encryption\Encrypter|null
     */
    ...
    protected function addCastAttributesToArray(array $attributes, array $mutatedAttributes)
    {
        foreach ($this->getCasts() as $key => $value) {
            ...
            // to strings based on the date format specified for these Instrument models.
    ...
    /**
     * Either throw a missing attribute exception or return null depending on Instrument's configuration.
     *
     * @param  string  $key
     * @return null
     *
     * @throws \Voyager\Database\Instrument\MissingAttributeException
     */
     ...
     *
     * @param  \Voyager\Contracts\Encryption\Encrypter|null  $encrypter
     * @return void
     */
     ...
     *
     * @return \Voyager\Contracts\Encryption\Encrypter
     */
     ...
     * @return bool
     *
     * @throws \Voyager\Database\Instrument\InvalidCastException
     */
