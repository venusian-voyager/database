...
use Voyager\Database\Query\Grammars\Grammar as QueryGrammar;
...
class Connection implements ConnectionInterface
{
     ...
     *
     * @var (callable(\Voyager\Database\Connection): mixed)
     */
     ...
     *
     * @var \Voyager\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @var \Voyager\Database\DatabaseTransactionsManager|null
     */
     ...
     *
     * @var array{has_run: bool, handler: (callable(\Voyager\Database\Connection, class-string<\Voyager\Database\Events\QueryExecuted>): mixed)}[]
     */
     ...
     *
     * @var (\Closure(string, array, \Voyager\Database\Connection): mixed)[]
     */
     ...
     *
     * @return \Voyager\Database\Schema\Grammars\Grammar|null
     */
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Contracts\Database\Query\Expression|\UnitEnum|string  $table
     ...
     * @return mixed
     *
     * @throws \Voyager\Database\MultipleColumnsSelectedException
     */
     ...
     * @return mixed
     *
     * @throws \Voyager\Database\QueryException
     */
     ...
     * @param  (callable(\Voyager\Database\Connection, \Voyager\Database\Events\QueryExecuted): mixed)  $handler
     * @return void
     */
     ...
     *
     * @param  \Voyager\Database\QueryException  $e
     * @param  string  $query
     * @param  array  $bindings
     * @param  \Closure  $callback
     * @return mixed
     ...
     * @return mixed|false
     *
     * @throws \Voyager\Database\LostConnectionException
     */
     ...
     *
     * @param  \Closure(\Voyager\Database\Events\QueryExecuted)  $callback
     * @return void
     */
     ...
     *
     * @param  (callable(\Voyager\Database\Connection): mixed)  $reconnector
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Query\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @return \Voyager\Database\Schema\Grammars\Grammar
     */
     ...
     *
     * @param  \Voyager\Database\Schema\Grammars\Grammar  $grammar
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Query\Processors\Processor  $processor
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\DatabaseTransactionsManager  $manager
     * @return $this
     */
