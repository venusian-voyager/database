...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\Voyager\NutsAndBolts\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \Voyager\NutsAndBolts\Collection<int, TReturn>
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \Voyager\NutsAndBolts\LazyCollection<int, TValue>
     *
     ...
     * @return TValue
     *
     * @throws \Voyager\Database\RecordNotFoundException
     */
     ...
     *
     * @param  \Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>  $builder
     ...
     * @param  int  $currentPage
     * @param  array  $options
     * @return \Voyager\Pagination\Paginator
     */
     ...
     * @param  \Voyager\NutsAndBolts\Collection  $items
     * @param  int  $perPage
     * @param  \Voyager\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \Voyager\Pagination\CursorPaginator
     */
