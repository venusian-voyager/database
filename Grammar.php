...
abstract class Grammar
{
     ...
     *
     * @param  array<\Voyager\Contracts\Database\Query\Expression|string>  $values
     * @return array<string>
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string|int|float  $expression
