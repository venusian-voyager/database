...
class MigrateCommand extends BaseCommand implements Isolatable
{
     ...
     *
     * @var \Voyager\Database\Migrations\Migrator
     */
    protected $migrator;
    ...
    {
        if ($this->venusian['config']->get("database.connections.{$connection->getName()}.database") !== $connection->getDatabaseName()) {
            return false;
        }
        ...
        try {
            ...
            $this->venusian['config']->set("database.connections.{$connection->getName()}.database", $connection->getDatabaseName());
        }
    }
