...
namespace Voyager\Database\Query\Grammars;

use Voyager\Contracts\Database\Query\Expression;
use Voyager\Database\Concerns\CompilesJsonPaths;
use Voyager\Database\Grammar as BaseGrammar;
use Voyager\Database\Query\Builder;
use Voyager\Database\Query\JoinClause;
use Voyager\Database\Query\JoinLateralClause;
...
class Grammar extends BaseGrammar
{
    ...
    public function compileSelect(Builder $query)
    {
        ...
        // Instrument. We'll also set the columns if they have not been defined.
     ...
     *
     * @param  \Voyager\Database\Query\Builder  $query
     * @param  array{function: string, columns: array<\Voyager\Contracts\Database\Query\Expression|string>}  $aggregate
     * @return string
     */
     ...
     *
     * @param  \Voyager\Database\Query\JoinLateralClause  $join
