...
class MySqlGrammar extends Grammar
{
     ...
     *
     * @param  \Voyager\Database\Query\Builder  $query
     * @param  \Voyager\Database\Query\IndexHint  $indexHint
     * @return string
     *
     ...
     *
     * Derived from https://softonsofa.com/tweaking-instrument-relations-how-to-get-n-related-models-per-parent/.
     *
     * @param  \Voyager\Database\Query\Builder  $query
     * @return string
     */
