...
use Voyager\Contracts\Database\Query\Builder as BuilderContract;
use Voyager\Contracts\Database\Query\ConditionExpression;
use Voyager\Contracts\Database\Query\Expression as ExpressionContract;
use Voyager\Contracts\NutsAndBolts\Arrayable;
use Voyager\Database\Concerns\BuildsQueries;
use Voyager\Database\Concerns\BuildsWhereDateClauses;
use Voyager\Database\Concerns\ExplainsQueries;
...
{
    /** @use \Voyager\Database\Concerns\BuildsQueries<\stdClass> */
     ...
     *
     * @var \Voyager\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Voyager\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     * @var array{
     *     function: string,
     *     columns: array<\Voyager\Contracts\Database\Query\Expression|string>
     * }|null
     */
    public $aggregate;
     ...
     *
     * @var array<string|\Voyager\Contracts\Database\Query\Expression>|null
     */
    public $columns;
     ...
     *
     * @var \Voyager\Database\Query\Expression|string
     */
    public $from;
     ...
     *
     * @var \Voyager\Database\Query\IndexHint|null
     */
    public $indexHint;
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $expression
     * @param  string  $as
     * @return $this
     */
    ...
    {
        if ($query instanceof self || $query instanceof InstrumentBuilder || $query instanceof Relation) {
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $column
     * @param  \Voyager\NutsAndBolts\Collection<int, float>|\Voyager\Contracts\NutsAndBolts\Arrayable|array<int, float>|string  $vector
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>|\Voyager\Contracts\Database\Query\Expression|string  $table
     * @param  string|null  $as
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Voyager\Contracts\Database\Query\Expression|string  $first
     * @param  string|null  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|string|null  $second
     * @param  string  $type
     * @param  bool  $where
     * @return $this
     */
     ...
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $second
     * @param  string  $type
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $table
     * @param  \Closure|\Voyager\Contracts\Database\Query\Expression|string|null  $first
     * @param  string|null  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|string|null  $second
     * @return $this
     */
     ...
     * @param  string  $type
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $table
     * @return \Voyager\Database\Query\JoinClause
     */
     ...
     * @param  string  $type
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $table
     * @return \Voyager\Database\Query\JoinLateralClause
     */
     ...
     *
     * @param  \Closure|string|array|\Voyager\Contracts\Database\Query\Expression  $column
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string|array  $first
     * @param  string|null  $operator
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $sql
     * @param  mixed  $bindings
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  string  $column
     * @param  \Voyager\Contracts\NutsAndBolts\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Voyager\Contracts\Database\Query\Expression  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|array|\Voyager\Contracts\Database\Query\Expression  $column
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>|\Voyager\Contracts\Database\Query\Expression|string  $column
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  mixed  $value
     * @param  array{\Voyager\Contracts\Database\Query\Expression|string, \Voyager\Contracts\Database\Query\Expression|string}  $columns
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Database\Query\Builder  $query
     * @param  string  $boolean
     * @return $this
     */
     ...
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $column
     * @param  string  $operator
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>  $callback
     * @param  string  $boolean
     * @return $this
     */
    protected function whereSub($column, $operator, $callback, $boolean)
    {
        ...
        if ($callback instanceof Closure) {
            ...
            $query = $callback instanceof InstrumentBuilder ? $callback->toBase() : $callback;
        }
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression[]|\Closure[]|string[]  $columns
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  array|\Voyager\Contracts\Database\Query\Expression|string  ...$groups
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|\Closure|string  $column
     * @param  \DateTimeInterface|string|int|float|null  $operator
     * @param  \Voyager\Contracts\Database\Query\Expression|\DateTimeInterface|string|int|float|null  $value
     * @param  string  $boolean
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>|\Voyager\Contracts\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Contracts\Database\Query\Expression|string  $column
     * @return $this
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $column
     * @param  \Voyager\NutsAndBolts\Collection<int, float>|\Voyager\Contracts\NutsAndBolts\Arrayable|array<int, float>  $vector
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Contracts\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Closure|\Voyager\Database\Query\Builder|\Voyager\Database\Instrument\Builder<*>  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     *
     * @param  int|string  $id
     * @param  string|\Voyager\Contracts\Database\Query\Expression|array<string|\Voyager\Contracts\Database\Query\Expression>  $columns
     ...
     *
     * @param  mixed  $id
     * @param  (\Closure(): TValue)|string|\Voyager\Contracts\Database\Query\Expression|array<string|\Voyager\Contracts\Database\Query\Expression>  $columns
     ...
     * @return mixed
     *
     * @throws \Voyager\Database\RecordsNotFoundException
     * @throws \Voyager\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  string|\Voyager\Contracts\Database\Query\Expression|array<string|\Voyager\Contracts\Database\Query\Expression>  $columns
     * @return \Voyager\NutsAndBolts\Collection<int, \stdClass>
     */
     ...
     *
     * @param  \Voyager\NutsAndBolts\Collection  $items
     ...
     * @return \Voyager\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Voyager\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Voyager\Pagination\Cursor|string|null  $cursor
     * @return \Voyager\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array<string|\Voyager\Contracts\Database\Query\Expression>  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  array<string|\Voyager\Contracts\Database\Query\Expression>  $columns
     * @return array<string|\Voyager\Contracts\Database\Query\Expression>
     */
     ...
     *
     * @return \Voyager\NutsAndBolts\LazyCollection<int, \stdClass>
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Query\Expression|string  $columns
     * @return int<0, max>
     */
     ...
     *
     * @param  string  $function
     * @param  array<\Voyager\Contracts\Database\Query\Expression|string>  $columns
     * @return $this
     */
    ...
    public function update(array $values)
    {
        ...
        $values = (new Collection($values))->map(function ($value) {
            if (! $value instanceof self && ! $value instanceof InstrumentBuilder && ! $value instanceof Relation) {
     ...
     *
     * @param  mixed  $value
     * @return \Voyager\Contracts\Database\Query\Expression
     */
     ...
     *
     * @return \Voyager\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Voyager\Database\Query\Grammars\Grammar
     */
    ...
    protected function isQueryable($value)
    {
        return $value instanceof self ||
               $value instanceof InstrumentBuilder ||
