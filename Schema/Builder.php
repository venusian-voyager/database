...
class Builder
{
     ...
     *
     * @var \Closure(\Voyager\Database\Connection, string, \Closure|null): \Voyager\Database\Schema\Blueprint
     */
    protected $resolver;
     ...
     * @return \Voyager\Database\Schema\Blueprint
     */
     ...
     *
     * @param  \Closure(\Voyager\Database\Connection, string, \Closure|null): \Voyager\Database\Schema\Blueprint  $resolver
     * @return void
     */
