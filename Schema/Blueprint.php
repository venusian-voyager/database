...
class Blueprint
{
     ...
     *
     * @var \Voyager\Database\Schema\ColumnDefinition[]
     */
    protected $columns = [];
     ...
     *
     * @var \Voyager\NutsAndBolts\Fluent[]
     */
    protected $commands = [];
     ...
     *
     * @var \Voyager\Database\Schema\BlueprintState|null
     */
    protected $state;
     ...
     *
     * @return \Voyager\NutsAndBolts\Fluent
     */
     ...
     * Indicate that the given foreign key should be dropped.
     *
     * @param  \Voyager\Database\Instrument\Model|string  $model
     ...
     * @return \Voyager\Database\Schema\IndexDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Voyager\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @param  string  $column
     * @return \Voyager\Database\Schema\ForeignIdColumnDefinition
     */
     ...
     *
     * @param  int|null  $precision
     * @return \Voyager\NutsAndBolts\Collection<int, \Voyager\Database\Schema\ColumnDefinition>
     */
     ...
     *
     * @param  \Voyager\Database\Schema\ColumnDefinition  $definition
     * @return \Voyager\Database\Schema\ColumnDefinition
     */
     ...
     *
     * @return \Voyager\Database\Schema\BlueprintState
     */
