...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Voyager\Database\Schema\Blueprint  $blueprint
     * @param  \Voyager\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     * @param  \Voyager\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Voyager\NutsAndBolts\Fluent|null
     */
     ...
     *
     * @param  \Voyager\NutsAndBolts\Fluent|\Voyager\Contracts\Database\Query\Expression|string  $value
     * @return string
     */
