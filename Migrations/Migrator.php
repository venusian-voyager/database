...
use Voyager\Database\Events\MigrationSkipped;
use Voyager\Database\Events\MigrationsStarted;
use Voyager\Database\Events\MigrationStarted;
use Voyager\Database\Events\NoPendingMigrations;
...
class Migrator
{
     ...
     *
     * @var (\Closure(\Voyager\Database\ConnectionResolverInterface, ?string): \Voyager\Database\Connection)|null
     */
     ...
     *
     * @var array<string, \Voyager\Database\Migrations\Migration|null>
     */
     ...
     *
     * @param  \Closure(\Voyager\Database\ConnectionResolverInterface, ?string): \Voyager\Database\Connection  $callback
     * @return void
     */
     ...
     *
     * @return \Voyager\Database\Migrations\MigrationRepositoryInterface
     */
     ...
     *
     * @param  \Voyager\Contracts\Database\Events\MigrationEvent  $event
     * @return void
     */
